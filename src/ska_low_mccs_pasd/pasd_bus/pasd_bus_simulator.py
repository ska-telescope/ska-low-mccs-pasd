...
class FndhSimulator(PasdHardwareSimulator):
    ...
    DEFAULT_PSU48V_CURRENT: Final = 1410
...
class SmartboxSimulator(PasdHardwareSimulator):
    ...
    DEFAULT_POWER_SUPPLY_OUTPUT_VOLTAGE: Final = 470
    DEFAULT_POWER_SUPPLY_TEMPERATURE: Final = 4210
    DEFAULT_PCB_TEMPERATURE: Final = 3860  # Not implemented in hardware?
    DEFAULT_FEM_AMBIENT_TEMPERATURE: Final = 3910
    DEFAULT_FEM_CASE_TEMPERATURE_1: Final = 3840
    DEFAULT_FEM_CASE_TEMPERATURE_2: Final = 3760
    DEFAULT_FEM_HEATSINK_TEMPERATURE_1: Final = 3880
    DEFAULT_FEM_HEATSINK_TEMPERATURE_2: Final = 3550
