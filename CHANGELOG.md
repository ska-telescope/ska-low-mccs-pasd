...
* [SPTS-925] Reset the FNCC status register when an error is encountered and add resetCount attribute to FNCC device.
...
* [THORN-408] Increase the Smartbox power on timeout
