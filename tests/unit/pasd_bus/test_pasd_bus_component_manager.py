        ...
        for i in range(1, 5):
            ...
            for j, desired in enumerate(desired_port_powers):
                if desired is None:
                    continue
                if desired:
                    expected_desired_power_when_online[j] = DesiredPowerEnum.ON
                    expected_desired_power_when_offline[j] = (
                        DesiredPowerEnum.ON
                    ...
                    expected_desired_power_when_online[j] = DesiredPowerEnum.OFF
